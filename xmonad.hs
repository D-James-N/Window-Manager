...
main = do
	...
	, modMask = mod4Mask     -- Rebind Mod to the Win key
        ...
        [ ((controlMask .|. mod1Mask, xK_Return), spawn "xscreensaver-command -lock; xset dpms force off")
        , ((controlMask, xK_Print), spawn "sleep 0.2; scrot -s")
        , ((0, xK_Print), spawn "scrot")

    -- Configure XMonad to use pactl
	...
	, ((mod4Mask, xK_Escape), spawn "bash ~/.xmonad/layout_switch.sh")
--        , ((shiftMask, 0xff80), spawn "bash ~/.xmonad/layout_switch.sh")
        ]
...
myBrowser :: String
myBrowser = "firefox-esr"  -- Sets qutebrowser as browser
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- Brightness
    , ((0, xF86XK_KbdBrightnessUp),   spawn "brightnessctl set +10%")
    ...
    -- Move focus to the mas/ter window
 ...
 --   , ((modm,               xK_l     ), sendMessage Expand)
    ...
    -- Run xmessage with a summary of the default keybindXF86XK_PowerDownings (useful for beginners)
